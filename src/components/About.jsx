  ...
  return (
    <div className='about'>
        ...
        <div className='in-about'>
            ...
            <p><span style={{ color:'#FF7E29'}}>TENR Global Solution Private Limited</span> Is a reputable and legitimate research and development organization, specializing in Real, Unique, Genuine, and Legitimate <b>ONLINE HOME JOBS</b>. With over 8 years of experience, we are a leader in providing online home job opportunities not only within India but also worldwide. We are expertise in <b>creating effective job programs through years of research</b>. Beware of scams in the internet world,  <b>“75%</b> of online job offers are deceitful, wasting people’s money and valuable time”. Only <b>25%</b> of companies are genuine based on our experience. <span style={{ color:'#FF7E29'}}>TENR Global Solution</span> aims to provide accurate and up-to-date information about legitimate online job opportunities to help individuals avoid scams.
            <br/> <br/>
        ...
        <div className='features'>
            ...
            <div className='in-data'>
                ...
                <p>Our customer support is available 24/7, providing robust assistance.</p>
            </div>
        </div>
    </div>  
  )
